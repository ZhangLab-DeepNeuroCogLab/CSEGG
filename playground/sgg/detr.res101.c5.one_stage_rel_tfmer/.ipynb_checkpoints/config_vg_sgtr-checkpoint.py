...
_config_dict = dict(
    ...
    EXPERIMENT_NAME=f"(top1)VG-SGTR_SAMPLE_RUN_EWC_short-dec_layer{rel_dec_layer}",
    ...
    MODEL=dict(
        ...
        #####
        TEST_WEIGHTS="/home/naitik/projects/SGG_Continual/models/experiments/SGTR_joint/playground/sgg/detr.res101.c5.one_stage_rel_tfmer/eval/replay_2_checkpoint/model_final.pth",

        WEIGHTS="/home/naitik/projects/SGG_Continual/models/experiments/SGTR_joint/playground/sgg/detr.res101.c5.one_stage_rel_tfmer/eval/task_1_checkpoint/model_final.pth",

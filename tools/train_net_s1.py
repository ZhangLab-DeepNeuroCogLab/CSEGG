...
def stage_main(args, cfg, build):
    ...
    task_list = ['s1_task_1', 's1_task_2', 's1_task_3', 's1_task_4', 's1_task_5']
    ...
    for i in range((int(args.start_task) - 1) , num_tasks):
        ...
        elif continual_method == "replay_100" and task_number > 1:
            cfg.DATASETS.TRAIN.append("vgs_" + task_list[i-1] + "_train_exempler_100")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--continual", choices=["replay_10", "ewc", "replay_100", False], required=False, default = False)
